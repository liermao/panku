...
var require_swiper = __commonJS({
  "node_modules/swiper/js/swiper.js"(exports, module) {
    (function(global, factory) {
      ...
      function addClass(className) {
        ...
        var classes2 = className.split(" ");
        for (var i = 0; i < classes2.length; i += 1) {
      ...
      function transitionEnd(callback) {
        var events2 = ["webkitTransitionEnd", "transitionend"];
        var dom = this;
        var i;
      ...
      var Utils = {
        ...
        getTranslate: function getTranslate2(el, axis) {
      ...
      var SwiperClass = function SwiperClass2(params) {
        if (params === void 0) params = {};
        var self2 = this;
        self2.params = params;
        self2.eventsListeners = {};
        if (self2.params && self2.params.on) {
          Object.keys(self2.params.on).forEach(function(eventName) {
            self2.on(eventName, self2.params.on[eventName]);
          });
        }
      };
      var staticAccessors = { components: { configurable: true } };
      SwiperClass.prototype.on = function on2(events2, handler, priority) {
        var self2 = this;
      ...
      SwiperClass.prototype.once = function once(events2, handler, priority) {
        var self2 = this;
        if (typeof handler !== "function") {
          return self2;
        }
      ...
      SwiperClass.prototype.off = function off2(events2, handler) {
        var self2 = this;
      ...
      SwiperClass.prototype.useModulesParams = function useModulesParams(instanceParams) {
        ...
        Object.keys(instance.modules).forEach(function(moduleName) {
          ...
          if (module2.params) {
            Utils.extend(instanceParams, module2.params);
          }
        });
      };
      SwiperClass.prototype.useModules = function useModules(modulesParams) {
        ...
        Object.keys(instance.modules).forEach(function(moduleName) {
          ...
          if (module2.instance) {
            Object.keys(module2.instance).forEach(function(modulePropName) {
              var moduleProp = module2.instance[modulePropName];
      ...
      staticAccessors.components.set = function(components2) {
        var Class = this;
        if (!Class.use) {
          return;
        }
      ...
      SwiperClass.installModule = function installModule(module2) {
        ...
        var name = module2.name || Object.keys(Class.prototype.modules).length + "_" + Utils.now();
        Class.prototype.modules[name] = module2;
        if (module2.proto) {
          Object.keys(module2.proto).forEach(function(key) {
            Class.prototype[key] = module2.proto[key];
          });
        }
        if (module2.static) {
          Object.keys(module2.static).forEach(function(key) {
            Class[key] = module2.static[key];
          });
        }
        if (module2.install) {
          module2.install.apply(Class, params);
        }
        return Class;
      };
      SwiperClass.use = function use(module2) {
        var params = [], len = arguments.length - 1;
        while (len-- > 0) params[len] = arguments[len + 1];
        var Class = this;
        ...
        return Class.installModule.apply(Class, [module2].concat(params));
      };
      ...
      function updateSlides() {
        ...
        for (var i = 0; i < slidesLength; i += 1) {
          ...
          if (params.slidesPerView === "auto") {
            var slideStyles = win.getComputedStyle(slide2[0], null);
      ...
      function updateAutoHeight(speed) {
        ...
        if (swiper.params.slidesPerView !== "auto" && swiper.params.slidesPerView > 1) {
          if (swiper.params.centeredSlides) {
            swiper.visibleSlides.each(function(index3, slide2) {
      ...
      function getTranslate(axis) {
        ...
        var params = swiper.params;
        var rtl = swiper.rtlTranslate;
        var translate2 = swiper.translate;
        var $wrapperEl = swiper.$wrapperEl;
      ...
      function slideToClosest(speed, runCallbacks, internal, threshold) {
        ...
        if (translate2 >= swiper.snapGrid[snapIndex]) {
          ...
          if (translate2 - prevSnap <= (currentSnap$1 - prevSnap) * threshold) {
            index2 -= swiper.params.slidesPerGroup;
          }
        }
      ...
      function loopCreate() {
        ...
        var prependSlides = [];
        var appendSlides = [];
        slides.each(function(index2, el) {
          var slide2 = $(el);
      ...
      function setBreakpoint() {
        ...
        var breakpoint = swiper.getBreakpoint(breakpoints2);
      ...
      function getBreakpoint(breakpoints2) {
        ...
        var points = Object.keys(breakpoints2).map(function(point2) {
          if (typeof point2 === "string" && point2.indexOf("@") === 0) {
            ...
            var value2 = win.innerHeight * minRatio;
            return { value: value2, point: point2 };
          }
          return { value: point2, point: point2 };
        });
      ...
      var Swiper = function(SwiperClass2) {
        function Swiper2() {
          var assign;
          var args = [], len = arguments.length;
          while (len--) args[len] = arguments[len];
          ...
          if ($el.length > 1) {
            var swipers = [];
            $el.each(function(index2, containerEl) {
        ...
        if (SwiperClass2) Swiper2.__proto__ = SwiperClass2;
        Swiper2.prototype = Object.create(SwiperClass2 && SwiperClass2.prototype);
        Swiper2.prototype.constructor = Swiper2;
        var staticAccessors2 = { extendedDefaults: { configurable: true }, defaults: { configurable: true }, Class: { configurable: true }, $: { configurable: true } };
        Swiper2.prototype.slidesPerViewDynamic = function slidesPerViewDynamic() {
          var swiper = this;
          var params = swiper.params;
          var slides = swiper.slides;
          var slidesGrid = swiper.slidesGrid;
        ...
        Swiper2.prototype.update = function update2() {
          var swiper = this;
          if (!swiper || swiper.destroyed) {
            return;
          }
        ...
        Swiper2.prototype.changeDirection = function changeDirection(newDirection, needUpdate) {
        ...
        Swiper2.prototype.init = function init() {
          var swiper = this;
        ...
        Swiper2.prototype.destroy = function destroy(deleteInstance, cleanStyles) {
        ...
        staticAccessors2.extendedDefaults.get = function() {
          return extendedDefaults;
        };
        staticAccessors2.defaults.get = function() {
          return defaults;
        };
        staticAccessors2.Class.get = function() {
          return SwiperClass2;
        };
        staticAccessors2.$.get = function() {
          return $;
        };
        Object.defineProperties(Swiper2, staticAccessors2);
        return Swiper2;
      }(SwiperClass);
      var Device$1 = {
        name: "device",
      ...
      var Pagination = {
        update: function update2() {
          ...
          if (params.type === "bullets" && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
            ...
            if ($el.length > 1) {
              bullets.each(function(index2, bullet) {
                var $bullet2 = $(bullet);
      ...
      var Parallax = {
        ...
        setTranslate: function setTranslate2() {
          ...
          var progress = swiper.progress;
          var snapGrid = swiper.snapGrid;
          $el.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(index2, el) {
          ...
          slides.each(function(slideIndex, slideEl) {
            ...
            $(slideEl).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(index2, el) {
        ...
        setTransition: function setTransition2(duration) {
          ...
          var swiper = this;
          var $el = swiper.$el;
          $el.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(index2, parallaxEl) {
      ...
      var Zoom$1 = {
        ...
        on: {
          ...
          transitionEnd: function transitionEnd2() {
            var swiper = this;
      ...
      var Lazy$1 = {
        ...
        on: {
          ...
          transitionStart: function transitionStart2() {
            var swiper = this;
            if (swiper.params.lazy.enabled) {
      ...
      var Controller = {
        ...
        setTranslate: function setTranslate2(setTranslate$1, byController) {
          var swiper = this;
      ...
      var Controller$1 = {
        ...
        on: {
          ...
          setTranslate: function setTranslate2(translate2, byController) {
            var swiper = this;
            if (!swiper.controller.control) {
              return;
            }
      ...
      var Thumbs = {
        init: function init() {
          ...
          var SwiperClass2 = swiper.constructor;
...
export default require_swiper();
//# sourceMappingURL=swiper_js_swiper__js.js.map
